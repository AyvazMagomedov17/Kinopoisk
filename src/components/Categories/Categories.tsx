...
const Categories = ({ baseUrl, title, genresCountriesList }: Props) => {
    ...
    const genres = genresCountriesList?.genres.map(genre => {
        if (genre.genre) {
    ...
    const countries = genresCountriesList?.countries.map(country => {
