...
const FilmMainLeft = ({ film, awards, staff }: Props) => {
    ...
    return (
        <Grid container flexDirection='column' alignItems='center'>
            ...
            {isAddedInFavorite && <Alert sx={{ 'position': 'fixed', 'bottom': '20px', 'left': '20px', 'zIndex': 100000 }} variant="filled" severity="success">Фильм добавлен в <a style={{ 'color': "#ffff" }} target='__blank' href="/favorites">избранное</a>  </Alert>}
            {isDeletedInFavorite && <Alert sx={{ 'position': 'fixed', 'bottom': '20px', 'left': '20px', 'zIndex': 100000 }} variant="filled" severity="warning">Фильм удален из <a style={{ 'color': "#ffff" }} target='__blank' href="/favorites" >избранного</a></Alert>}
